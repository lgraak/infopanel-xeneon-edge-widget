...
Open the web server settings

Enable the web server

Bind it to the IP address of the Windows PC
...
Switch the Xeneon Edge to normal monitor mode

Edit the InfoPanel profile

Save the profile

Switch back to widget mode

Reload the iFrame widget if necessary
